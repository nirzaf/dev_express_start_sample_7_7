namespace sample_7_7.Views {
  partial class TaskView {
    ...
    private void InitializeComponent() {
      ...
      // 
      this.taskViewModelBindingSource.DataSource = typeof(sample_7_7.ViewModels.TaskViewModel);
      // 
      // DueDateDateEdit
      // 
      ...
      this.mvvmContext1.BindingExpressions.AddRange(new DevExpress.Utils.MVVM.BindingExpression[] {
            DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(sample_7_7.ViewModels.TaskViewModel), "Postpone", this.bbiPostpone),
            DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(sample_7_7.ViewModels.TaskViewModel), "MarkDone", this.bbiMarkDone)});
      ...
      this.mvvmContext1.ViewModelType = typeof(sample_7_7.ViewModels.TaskViewModel);
      // 
      // TaskView
      // 
